...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        ...
        out.println("Server: Write your name?"); System.out.println("Server: Write your name?");
        String username = in.readLine(); System.out.println("- " + username);
        out.println("Server: Are you child? (yes/no)"); System.out.println("Server: Are you child? (yes/no)");
        String answer = in.readLine(); System.out.println("- " + answer);
